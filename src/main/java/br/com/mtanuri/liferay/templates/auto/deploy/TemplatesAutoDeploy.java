...
import br.com.mtanuri.liferay.templates.auto.deploy.service.TemplateService;

@Component(immediate = true, property = { "cron.expression=0 * * ? * *	" }, service = TemplatesAutoDeploy.class)
public class TemplatesAutoDeploy extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		_log.debug("searching for templates to update...");
		templateService.processTemplates();
	}
